...
@title{MIDIFuncSrcMessageMatcherNV}
 Matches incoming MIDI messages to responder funcs based on message source@section{categories}
  External Control>MIDI>Matchers
@section{related}
  Classes/AbstractMessageMatcher, Classes/MIDIFuncSrcMessageMatcher, Classes/MIDIFuncChanMessageMatcher, Classes/MIDIFuncChanArrayMessageMatcher, Classes/MIDIFuncBothMessageMatcher, Classes/MIDIFuncBothCAMessageMatcher
