...
@title{Color}
 An object which stores color values@section{categories}
  GUI>Accessories
@section{related}
  Classes/Object
...
@section{method}
  rand
A random RGB Color where the colors are randomly chosen between 
@racketblock[lo:: and ]

@racketblock[hi::. See link::Classes/Color#new::.
]
@section{argument}
  lo
An instance of link::Classes/Float:: between 0 and 1.
...
Get/set one of the instance variables, 
@racketblock[red::, ]
...
@racketblock[green::, and ]

@racketblock[blue:: are scaled by the ]

@racketblock[alpha:: value, and alpha is set to 1.
]
...
@racketblock[blue::, and ]

@racketblock[alpha:: values of two Colors, linearly weighting between the first and the second.
]
@section{argument}
  that
A second Color.
...
@racketblock[[hue, saturation, value, alpha]::, as values between 0 and 1.

]
@section{method}
  asArray
Returns an array with 
@racketblock[[red, green, blue, alpha]::, as values between 0 and 1.

]
@section{method}
  storeArgs
Returns an array with 
@racketblock[[red, green, blue, alpha]::.

]
@section{method}
  setStroke
For use with link::Classes/Pen::. Sets the 
@racketblock[stroke:: of link::Classes/Pen:: to this.

]
@section{method}
  setFill
For use with link::Classes/Pen::. Sets the 
@racketblock[fill:: of link::Classes/Pen:: to this.

]
@section{method}
  set
For use with link::Classes/Pen::. Sets the 
@racketblock[stroke:: and ]
